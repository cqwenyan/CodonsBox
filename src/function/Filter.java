		...
		try {
			...
			while ((tempString = reader.readLine()) != null) {
				if (tempString.contains(">")) {
					...
					if ((TempStringLenth % 3 == 0)
							&& ((cleanTempString.substring(0, 3).toUpperCase())
									.equals("ATG") || (cleanTempString
									.substring(0, 3).toUpperCase())
									.equals("AUG"))
							&& ((cleanTempString.substring(TempStringLenth - 3,
									TempStringLenth).toUpperCase())
									.equals("ATG")
									|| (cleanTempString.substring(
											TempStringLenth - 3,
											TempStringLenth).toUpperCase())
											.equals("TAA")
									|| (cleanTempString.substring(
									...
									|| (cleanTempString.substring(
											TempStringLenth - 3,
											TempStringLenth).toUpperCase())
											.equals("UAG") || (cleanTempString
										.substring(TempStringLenth - 3,
												TempStringLenth).toUpperCase())
									.equals("UGA"))) {
						if (null != cleanTempString && "" != cleanTempString) {
							bw.write(tempStore + "\n");
							for (int i = 0; i < (TempStringLenth / 60) - 1; i++) {
								bw.write(cleanTempString.substring(60 * i,
										60 * (i + 1)) + "\n");
							}
							bw.write(cleanTempString.substring(
									(TempStringLenth / 60) * 60,
									TempStringLenth)
									+ "\n");
						}
					}
